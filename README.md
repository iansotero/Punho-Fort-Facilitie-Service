...
    color: #333;
    padding-top: 120px; /* top-bar + nav-bar */
}
...
/* SCROLL PARA ANCORAS COM DUAS BARRAS FIXAS */
:target {
    scroll-margin-top: 130px; /* top-bar + nav-bar */
}
...
<header>
    <!-- BARRA SUPERIOR: Logo e Nome -->
    <div class="top-bar">
        <div class="logo">
            <img src="https://media.licdn.com/dms/image/v2/C4D0BAQEmT-m-5CKL9w/company-logo_200_200/company-logo_200_200/0/1630498690652?e=2147483647&v=beta&t=jqtSO1BnHPlYqx6y9RWFzABdLUBLTRFCjRcwSpH4ocQ" alt="Logo Punho Fort">
...
            <a href="javascript:void(0)" onclick="abrirLogin()"><span>🏠</span>Login</a>
        </nav>
    </div>
</header>
